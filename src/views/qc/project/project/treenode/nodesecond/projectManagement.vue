<template>
  <div style="height:800px">
    <div class="filter-container">
      ...
      <el-button
        v-permission="['root','project_manager_project_second_project_add']"
        type="primary"
        size="small"
        icon="el-icon-plus"
        class="filter-item"
      ...
      >
        <template slot-scope="scope">
          <el-tooltip content=" 编辑" placement="top">
            <el-button
              v-permission="['root','project_manager_project_second_project_edit']"
              size="small"
              type="primary"
              icon="el-icon-edit"
              circle
          ...
          <el-tooltip content="申请" placement="top">
            <el-button
              v-permission="['root','project_manager_project_second_project_apply']"
              size="small"
              type="success"
              icon="el-icon-phone"
              circle
          ...
          <el-tooltip content="删除" placement="top">
            <el-button
              v-permission="['root','project_manager_project_second_project_delete']"
              size="small"
              type="danger"
              icon="el-icon-delete"
              circle
